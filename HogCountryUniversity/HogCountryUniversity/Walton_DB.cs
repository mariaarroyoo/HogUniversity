        ...
        while (Retry >= 0)
        {
            try
            {
                if (lo_Connection == null)
                {
                    ...
                    lo_Connection.ConnectionString = "Data Source=isys3393.walton.uark.edu;Initial Catalog=3393_Liu_Fall2021p;user id=mariaa;password=BizDevPass10985394!;Persist Security Info=False;";
                }
